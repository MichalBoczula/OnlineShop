...
namespace OnlineShop.Test.Infrastructure.IOHelper.IOManager
{
    public class FileManagerTest
    {
        ...
        public void AddCameraToFile()
        {
            ...
            fileManager.ReadDataFromCSV<CameraCSV>("..\\..\\..\\..\\OnlineShop.Web\\Infrastructure\\Helper\\CSVSeed\\Camera.csv", result);
            //Assert
            result.Should().NotBeEmpty();
            result.Count.Should().Be(1);
            //Clean Up
            File.Delete("..\\..\\..\\..\\OnlineShop.Web\\Infrastructure\\Helper\\CSVSeed\\Camera.csv");
        }
        ...
        public void AddHardwareToFile()
        {
            ...
            fileManager.ReadDataFromCSV<HardwareCSV>("..\\..\\..\\..\\OnlineShop.Web\\Infrastructure\\Helper\\CSVSeed\\Hardware.csv", result);
            //Assert
            result.Should().NotBeEmpty();
            result.Count.Should().Be(1);
            //Clean Up
            File.Delete("..\\..\\..\\..\\OnlineShop.Web\\Infrastructure\\Helper\\CSVSeed\\Hardware.csv");
        }
        ...
        public void AddScreenToFile()
        {
            ...
            fileManager.ReadDataFromCSV<ScreenCSV>("..\\..\\..\\..\\OnlineShop.Web\\Infrastructure\\Helper\\CSVSeed\\Screen.csv", result);
            //Assert
            result.Should().NotBeEmpty();
            result.Count.Should().Be(1);
            //Clean Up
            File.Delete("..\\..\\..\\..\\OnlineShop.Web\\Infrastructure\\Helper\\CSVSeed\\Screen.csv");
        }
        ...
        public void AddMobilePhoneToFile()
        {
            ...
            fileManager.ReadDataFromCSV<MobilePhoneCSV>("..\\..\\..\\..\\OnlineShop.Web\\Infrastructure\\Helper\\CSVSeed\\MobilePhone.csv", result);
            //Assert
            result.Should().NotBeEmpty();
            result.Count.Should().Be(1);
            //Clean Up
            File.Delete("..\\..\\..\\..\\OnlineShop.Web\\Infrastructure\\Helper\\CSVSeed\\MobilePhone.csv");
        }
