...
namespace OnlineShop.Web.Infrastructure
{
    public class CSVDBContext
    {
        ...
        public CSVDBContext()
        {
            generalPath = "..\\OnlineShop.Infrastructure\\Helper";
            cameraPath = $"{generalPath}\\CSVSeed\\Camera.csv";
            hardwarePath = $"{generalPath}\\CSVSeed\\Hardware.csv";
            screenPath = $"{generalPath}\\CSVSeed\\Screen.csv";
            mobilePhonePath = $"{generalPath}\\CSVSeed\\MobilePhone.csv";
            multimediaPath = $"{generalPath}\\CSVSeed\\Multimedia.csv";
